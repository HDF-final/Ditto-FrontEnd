...
function buildBackendUrl(request, postId) {
  ...
  return `${baseUrl}/api/v1/community/courses/${postId}/comments${url.search}`;
}
...
async function proxyCommunityComments(request, { params }) {
...
export const GET = proxyCommunityComments;
export const POST = proxyCommunityComments;
export const OPTIONS = proxyCommunityComments;
