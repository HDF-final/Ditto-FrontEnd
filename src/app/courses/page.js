      ...
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="mb-8 flex flex-col gap-5 sm:mb-10 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black tracking-tight text-ink sm:text-4xl lg:text-5xl">
              {t("listTitle")}
            </h1>
            <p className="mt-3 max-w-[620px] text-sm font-medium leading-relaxed text-ink-muted sm:text-base">
              {t("listDescription")}
            </p>
          </div>
        </div>
        ...
        {courseCards.length > 0 ? (
          ...
          <div className="rounded-[26px] border border-dashed border-[#ded7f7] bg-white px-6 py-20 text-center">
            <p className="text-lg font-black text-ink">표시할 기본 코스가 없어요</p>
