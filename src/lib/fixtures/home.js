export const heroSlides = [
  {
    ...
    suffix: "경험하세요",
    description:
      "AI 맞춤 코스 추천부터 실시간 트렌드, 팝업 정보까지 당신의 한국 여행을 더 특별하게 만들어드려요.",
    ctaLabel: "AI 코스 만들기",
    href: "/ai-course",
    visualTitle: "DITTO",
    visualNote: "브랜드 키비주얼 · 마스코트 이미지 영역",
  ...
  },
  {
    ...
    suffix: "를 실시간으로 만나요",
    description:
      "인기 팝업스토어와 K-컬처 소식을 매일 업데이트. 놓치기 쉬운 핫플레이스까지 한눈에 확인하세요.",
    ctaLabel: "트렌드 보기",
    href: "/news",
    visualTitle: "TREND",
    visualNote: "실시간 인기 팝업 · 트렌드 이미지 영역",
  ...
  },
  {
    ...
    suffix: "완성하세요",
    description:
      "원하는 스팟만 골라 담으면 최적 동선까지 자동 완성. 여행 기록도 앱 하나로 간편하게 남겨보세요.",
    ctaLabel: "코스 만들기",
    href: "/ai-course",
    visualTitle: "MY COURSE",
    visualNote: "커스텀 코스 · 지도 이미지 영역",
