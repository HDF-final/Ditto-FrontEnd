...
export function getPersonaById(id = DEFAULT_PERSONA_ID, lang = "ko") {
  ...
  const themeMap = {
    openrun: {
      ...
      statBorder: "#ffe8d6",
      softButtonBg: "#fff7ed",
      softButtonBorder: "#fed7aa",
      softButtonText: "#ea580c",
      softButtonHover: "#ffedd5",
    },
    flex: {
      primaryColor: "#16a34a",
      primaryHover: "#15803d",
      ...
      statBorder: "#dcfce7",
      softButtonBg: "#f0fdf4",
      softButtonBorder: "#bbf7d0",
      softButtonText: "#16a34a",
      softButtonHover: "#dcfce7",
    },
    sohwak: {
      primaryColor: "#db2777",
      primaryHover: "#be185d",
      ...
      statBorder: "#fce7f3",
      softButtonBg: "#fdf2f8",
      softButtonBorder: "#fbcfe8",
      softButtonText: "#db2777",
      softButtonHover: "#fce7f3",
    },
    choae: {
      primaryColor: "#7c3aed",
      primaryHover: "#6d28d9",
      ...
      statBorder: "#ede9fe",
      softButtonBg: "#f5f3ff",
      softButtonBorder: "#e0d8ff",
      softButtonText: "#7c3aed",
      softButtonHover: "#ede9fe",
    },
  };
