      ...
      <div className="flex shrink-0 items-center gap-2 sm:gap-4 lg:gap-6">
        {activeUserIsAdmin ? (
          <Link
            href="/admin"
            aria-label="관리자 페이지"
            className="shrink-0 rounded-full border border-brand/20 bg-brand-soft px-3 py-2 text-xs font-black tracking-[0.08em] text-brand transition hover:border-brand hover:bg-brand hover:text-white"
          >
            ADMIN
          </Link>
        ) : (
