  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="line-clamp-2 text-lg font-black tracking-tight sm:text-xl lg:text-[26px] lg:leading-8">
          {course.englishTitle}
        </p>
      </div>
      <div className="flex flex-1 flex-col justify-center p-4 sm:p-5 lg:min-h-[140px] lg:justify-start lg:p-7">
        <h3 className="text-sm font-black text-ink group-hover:text-brand sm:text-base lg:text-lg">
          {course.title}
        </h3>
