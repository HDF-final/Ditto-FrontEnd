  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="line-clamp-2 text-[11px] font-black leading-[1.3] tracking-tight lg:text-[26px] lg:leading-8">
          {course.englishTitle}
        </p>
      </div>
      <div className="flex flex-1 flex-col justify-center p-3 lg:min-h-[140px] lg:justify-start lg:p-7">
        <h3 className="line-clamp-2 text-[11px] font-black leading-[1.35] text-ink group-hover:text-brand lg:text-lg">
          {course.title}
        </h3>
