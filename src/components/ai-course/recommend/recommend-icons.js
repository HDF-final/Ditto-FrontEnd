/**
 * Inline SVG icon set for the course recommendation flow.
 *
 * The Figma export used `lucide-react`, which is not a project dependency.
 * These lightweight components mirror the lucide paths and API (`size`,
 * `className`) so the markup ported over unchanged.
 */

function IconBase({ size = 24, className = "", strokeWidth = 2, children }) {
  return (
    <svg
